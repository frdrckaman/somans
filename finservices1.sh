...
if [ -f /fincor/capp/TZUAT/ConfigService/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/ConfigService.txt  ea248080@10.231.116.89:data/finservices/node1
fi 
...
rm -f /fincor/capp/TZUAT/finmonitor/FINRPT-finlstclnt.txt
 if [ -f /fincor/capp/TZUAT/finlstclnt/FINRPT/services/finrptsrvr/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/FINRPT-finlstclnt.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/comnclnt/FINRPT/services/finrptsrvr/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/FINRPT-comnclnt.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/CBC/services/cbc/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/CBC.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/finlistval/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Finlistval.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/coresession/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Coresession.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/referral/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Referral.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/uniser_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Uniser-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/mqmrtgsin_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/MQMRtgsIn-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/mqmrtgsout_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/MQMRtgsOut-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/mqmread_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/MQMRead-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/dispatcher1_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Dispatcher-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/binagent_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Binagent-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/swiftsrv_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Swiftsrv-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/pmssrv_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Pmssrv-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/genlimo_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Genlimo-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/aabsrv_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Aabsrv-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/eabgst_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Eabgst-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/trswift_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Trswift-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
...
if [ -f /fincor/capp/TZUAT/Finacle/FC/app/services/uplpsmsg_TZ/bin/*.pid ]; then
    ...
    scp /fincor/capp/TZUAT/finmonitor/Uplpsmsg-TZ.txt  ea248080@10.231.116.89:data/finservices/node1
fi
